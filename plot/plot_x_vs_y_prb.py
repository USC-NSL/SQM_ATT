...
grid()
a = sys.argv[1]
enb1 = a[a.find("2=")+2:a.find("_", a.find("2="))]
a = sys.argv[2]
enb2 = a[a.find("2=")+2:a.find("_", a.find("2="))]
ax = fig.add_subplot(111)    # The big subplot
ax.scatter(aa,b, alpha=0.5)
#ax.set_xlim([-0.5, 6.5])
#ax.legend(leg, fontsize=20, ncol=2)
ax.set_xlabel("PRB Utilization of " +enb1, fontsize=20)
ax.set_ylabel("PRB Utilization of "+enb2, fontsize=20)
...
fig.savefig("vs_prb_%s_%s.png"%(enb1, enb2), bbox_inches='tight')
